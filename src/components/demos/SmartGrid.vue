<template>
  <div>
    <ButtonGroup grouped>
      <Button type="button" @click="columns = 6">
        <template #icon>
      ...
      <Button type="button" @click="columns = 3">
        <template #icon>
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
            <path
      ...
      <Button type="button" @click="columns = 1">
        <template #icon>
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
    ...
    <div ref="gallery" class="gallery">
      <figure v-for="i in 6" :key="i" class="image">
        <img :src="`https://picsum.photos/id/${i * 100}/400/200`" loading="lazy" alt="" />
      </figure>
    </div>
  </div>
</template>
